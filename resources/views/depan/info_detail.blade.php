      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="embed-responsive embed-responsive-16by9">
            <iframe id="declinedframe" class="embed-responsive-item" src="https://drive.google.com/file/d/1xhxxDxiN0sESK0GM5AYO-6cSXSbVN5A3/preview"  allowfullscreen></iframe>
          </div>
        </div>
...
<script type="text/javascript">
  ...
  //aksi
  function view_sk(nama_id) {

    $('#declinedframe').attr('src', nama_id);
  }
