...
<div class="portlet light ">
    ...
    <div class="portlet-body form">
        <form role="form" method="POST" action="{{url('pengaduan-form')}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="form-body">
                <div class="form-group form-md-line-input form-md-floating-label">
                   ...
                   <input type="hidden" name="subject" value="{{ $aduan->subject }}" >
                    <input type="text" class="form-control" id="form_control_1" name="nama" value="{{ $aduan->nama }} - {{$aduan->telp}}" readonly="">
                    <label for="form_control_1">Nama Pengadu</label>
                    <span class="help-block"></span>
                </div>
                <div class="form-group form-md-line-input form-md-floating-label">
                    <input type="text" class="form-control" id="form_control_1" name="subject" value="{{ $aduan->subject }}" readonly="">
                    <label for="form_control_1">Judul Pengaduan</label>
                    <span class="help-block"></span>
                </div>
                <div class="form-group form-md-line-input form-md-floating-label">
                    <textarea class="form-control" readonly="" rows="12">{{ $aduan->laporan }}</textarea>
                ...
                <div class="form-group form-md-line-input form-md-floating-label">
                    <label for="form_control_1">Isi Balasan</label>
                    <input type="text" class="form-control" id="form_control_1" name="isi_balasan">
                    <span class="help-block"></span>
                </div>
                <div class="form-group form-md-line-input form-md-floating-label">
