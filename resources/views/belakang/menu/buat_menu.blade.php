...
<div class="portlet light ">
    ...
    <div class="portlet-body form">
        <form role="form" method="POST" action="{{url('panel/menu')}}">
        {{ csrf_field() }}
            <div class="form-body">
                <div class="form-group form-md-line-input form-md-floating-label">
                    <input type="text" class="form-control" id="form_control_1" name="nama" value="{{ old('nama') }}" >
                ...
                <div class="form-group last">
                    ...
                    <textarea id="siduy" name="isi">{!! old('isi') !!}</textarea>
                </div>
            </div>
